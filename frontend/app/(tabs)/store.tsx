...
function makeS(colors: any) { return StyleSheet.create({
  ...
  loadText: { color: colors.textMuted, fontSize: 16 },
  ...
  historyBtn: { width: 44, height: 44, borderRadius: 12, backgroundColor: colors.inputBg, justifyContent: 'center', alignItems: 'center' },
  // Balance
  balanceBar: { flexDirection: 'row', justifyContent: 'space-around', padding: 12, backgroundColor: colors.inputBg, marginHorizontal: 16, marginTop: 12, borderRadius: 12 },
  balanceItem: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  balanceText: { color: colors.text, fontSize: 14, fontWeight: 'bold' },
  // Filter
  filterScroll: { marginHorizontal: 16, marginTop: 12, marginBottom: 4 },
  filterRow: { flexDirection: 'row', gap: 8 },
  fChip: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: colors.inputBg, borderRadius: 16, paddingHorizontal: 14, paddingVertical: 8 },
  fActive: { backgroundColor: '#E91E63' },
  fText: { color: colors.textMuted, fontSize: 13, fontWeight: 'bold' },
  fTextActive: { color: colors.text },
  content: { padding: 16, paddingBottom: 32 },
  // Daily Free Money
  dailyCard: { backgroundColor: colors.card, borderRadius: 16, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#FFD700' },
  ...
  dailyDesc: { color: colors.textMuted, fontSize: 12, marginTop: 2 },
  ...
  // Stripe Notice
  stripeNotice: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: colors.surface, borderRadius: 10, padding: 12, marginBottom: 16, borderWidth: 1, borderColor: '#635BFF50' },
  stripeText: { flex: 1, color: '#635BFF', fontSize: 12, fontWeight: '600' },
  stripeLoadingBar: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10, backgroundColor: colors.surface, borderRadius: 10, padding: 14, marginBottom: 12, borderWidth: 1, borderColor: '#635BFF' },
  stripeLoadingText: { color: '#635BFF', fontSize: 14, fontWeight: '600' },
  // Item Card
  itemCard: { backgroundColor: colors.inputBg, borderRadius: 16, padding: 16, marginBottom: 12, position: 'relative' as any },
  ...
  itemInfo: { flex: 1 },
  itemName: { color: colors.text, fontSize: 17, fontWeight: 'bold' },
  itemDesc: { color: colors.textMuted, fontSize: 13, marginTop: 4 },
  ...
  buyPrice: { color: colors.text, fontSize: 18, fontWeight: 'bold' },
  ...
  summaryCard: { alignItems: 'center', backgroundColor: colors.inputBg, borderRadius: 16, padding: 24, marginBottom: 20 },
  sumIcon: { width: 56, height: 56, borderRadius: 16, justifyContent: 'center', alignItems: 'center', marginBottom: 12 },
  sumName: { color: colors.text, fontSize: 18, fontWeight: 'bold', marginBottom: 4 },
  sumReward: { color: '#4CAF50', fontSize: 16, fontWeight: 'bold', marginBottom: 8 },
  sumPrice: { color: '#FFD700', fontSize: 28, fontWeight: 'bold' },
  label: { color: colors.textMuted, fontSize: 14, marginBottom: 12 },
  ...
  stripeBtnText: { color: colors.text, fontSize: 18, fontWeight: 'bold' },
  ...
  demoBtn: { backgroundColor: colors.inputBg, borderRadius: 12, padding: 14, flexDirection: 'row', justifyContent: 'center', alignItems: 'center', gap: 8, borderWidth: 1, borderColor: colors.inputBorder },
  demoBtnText: { color: colors.textMuted, fontSize: 13, fontWeight: '600' },
  ...
  confirmText: { color: colors.text, fontSize: 18, fontWeight: 'bold' },
  // History
  emptyHistory: { alignItems: 'center', paddingVertical: 32 },
  emptyHistText: { color: colors.textMuted, fontSize: 16, marginTop: 12 },
  histItem: { flexDirection: 'row', alignItems: 'center', paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: colors.cardBorder },
  histInfo: { flex: 1 },
  histName: { color: colors.text, fontSize: 15, fontWeight: '600' },
  histDate: { color: colors.textMuted, fontSize: 12, marginTop: 4 },
