...
function makeS(colors: any) { return StyleSheet.create({
  container: { flex: 1, backgroundColor: colors.surface },
  center: { flex: 1, justifyContent: 'center', alignItems: 'center', gap: 12 },
  loadingText: { color: colors.textMuted, fontSize: 16 },
  header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 16, borderBottomWidth: 1, borderBottomColor: colors.cardBorder },
  title: { fontSize: 28, fontWeight: 'bold', color: colors.text },
  content: { padding: 16, paddingBottom: 32 },
  toggle: { flexDirection: 'row', margin: 16, marginBottom: 0, gap: 8 },
  toggleBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: 10, borderRadius: 10, backgroundColor: colors.inputBg, gap: 4 },
  toggleActive: { backgroundColor: '#4CAF50' },
  toggleText: { color: colors.textMuted, fontSize: 12, fontWeight: 'bold' },
  toggleTextActive: { color: colors.text },
  // Revenue Card
  revenueCard: { backgroundColor: colors.card, borderRadius: 16, padding: 20, marginBottom: 20, borderWidth: 2, borderColor: '#4CAF50' },
  revenueLabel: { color: colors.textMuted, fontSize: 14 },
  ...
  collectText: { color: colors.text, fontSize: 16, fontWeight: 'bold' },
  ...
  adText: { color: colors.text, fontSize: 14, fontWeight: 'bold' },
  adWatching: { backgroundColor: colors.inputBg, borderRadius: 12, padding: 14, alignItems: 'center', marginTop: 8 },
  adWatchingText: { color: colors.text, fontSize: 14, marginBottom: 8 },
  ...
  mergeBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, marginTop: 8, backgroundColor: colors.card, borderRadius: 12, padding: 14, borderWidth: 1, borderColor: '#2196F3' },
  mergeText: { color: '#2196F3', fontSize: 14, fontWeight: 'bold' },
  disabled: { opacity: 0.5 },
  // Company Card
  companyCard: { backgroundColor: colors.inputBg, borderRadius: 12, padding: 16, marginBottom: 12 },
  ...
  companyInfo: { flex: 1 },
  companyName: { color: colors.text, fontSize: 16, fontWeight: 'bold' },
  companySegment: { color: colors.textMuted, fontSize: 12 },
  companyRevenue: { alignItems: 'flex-end' },
  revText: { color: '#4CAF50', fontSize: 16, fontWeight: 'bold' },
  revLabel: { color: colors.textMuted, fontSize: 10 },
  companyDesc: { color: colors.textMuted, fontSize: 12, marginBottom: 8 },
  companyMeta: { flexDirection: 'row', gap: 16 },
  metaText: { color: colors.textMuted, fontSize: 11 },
  // Buy Card
  buyCard: { backgroundColor: colors.inputBg, borderRadius: 12, padding: 16, marginBottom: 12 },
  ownedCard: { opacity: 0.6 },
  buyHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: 8 },
  buyInfo: { flex: 1 },
  buyName: { color: colors.text, fontSize: 16, fontWeight: 'bold' },
  buySegment: { color: colors.textMuted, fontSize: 12 },
  buyPrice: { color: '#FFD700', fontSize: 16, fontWeight: 'bold' },
  buyDesc: { color: colors.textMuted, fontSize: 12, marginBottom: 8 },
  ...
  emptySub: { color: colors.textMuted, fontSize: 14, textAlign: 'center', marginTop: 8, maxWidth: 280 },
  goBtn: { backgroundColor: '#4CAF50', borderRadius: 12, paddingHorizontal: 24, paddingVertical: 12, marginTop: 20 },
  goBtnText: { color: colors.text, fontWeight: 'bold', fontSize: 16 },
  // Modals
  ...
  input: { backgroundColor: colors.inputBg, borderRadius: 12, padding: 16, color: colors.text, fontSize: 16, borderWidth: 1, borderColor: colors.inputBorder },
  segGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  segChip: { paddingHorizontal: 14, paddingVertical: 8, borderRadius: 20, backgroundColor: colors.inputBg, borderWidth: 1, borderColor: colors.inputBorder },
  segActive: { backgroundColor: '#4CAF50', borderColor: '#4CAF50' },
  segText: { color: colors.textMuted, fontSize: 12, fontWeight: 'bold' },
  segTextActive: { color: colors.text },
  createBtn: { backgroundColor: '#4CAF50', borderRadius: 12, padding: 16, alignItems: 'center', marginTop: 24 },
  createText: { color: colors.text, fontSize: 18, fontWeight: 'bold' },
  mergeOption: { backgroundColor: colors.inputBg, borderRadius: 10, padding: 14, marginBottom: 8, borderWidth: 1, borderColor: colors.inputBorder },
  mergeSelected: { borderColor: '#2196F3', backgroundColor: colors.card },
  mergeOptionText: { color: colors.text, fontSize: 14 },
  ...
  franchiseCountBadge: { position: 'absolute', top: -6, right: -6, backgroundColor: '#9C27B0', borderRadius: 10, minWidth: 20, height: 20, justifyContent: 'center', alignItems: 'center', paddingHorizontal: 4, borderWidth: 2, borderColor: colors.cardBorder },
  franchiseCountText: { color: colors.text, fontSize: 10, fontWeight: 'bold' },
  ...
  // Offers
  offersHeader: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 16, backgroundColor: colors.inputBg, borderRadius: 12, padding: 14, borderWidth: 1, borderColor: '#FF980040' },
  offersHeaderText: { color: '#FF9800', fontSize: 16, fontWeight: 'bold' },
  offerCard: { backgroundColor: colors.inputBg, borderRadius: 14, padding: 16, marginBottom: 14 },
  ...
  offerTimerText: { color: colors.textMuted, fontSize: 12 },
  offerBuyer: { color: colors.text, fontSize: 17, fontWeight: 'bold' },
  offerReason: { color: colors.textSecondary, fontSize: 13, marginTop: 2, marginBottom: 8 },
  offerCompanyRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: 12 },
  offerCompanyName: { color: colors.textSecondary, fontSize: 13, fontWeight: '600' },
  offerSegment: { color: colors.textMuted, fontSize: 12 },
  offerPriceBlock: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: colors.surface, borderRadius: 12, padding: 14, marginBottom: 10 },
  offerPriceItem: { flex: 1, alignItems: 'center' },
  offerArrow: { paddingHorizontal: 12 },
  offerPriceLabel: { color: colors.textMuted, fontSize: 11, marginBottom: 4 },
  offerPriceOld: { color: colors.textMuted, fontSize: 15, fontWeight: '600' },
  ...
  offerDeclineBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, backgroundColor: colors.surface, borderRadius: 10, padding: 12, borderWidth: 1, borderColor: '#F4433640' },
  ...
  offerAcceptText: { color: colors.text, fontSize: 14, fontWeight: 'bold' },
});
}
