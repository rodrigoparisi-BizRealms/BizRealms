...
const s = StyleSheet.create({
  ...
  // Revenue Card
  revenueCard: { backgroundColor: '#1e1e1e', borderRadius: 16, padding: 20, marginBottom: 20, borderWidth: 2, borderColor: '#4CAF50' },
  ...
  mergeBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, marginTop: 8, backgroundColor: '#1e1e1e', borderRadius: 12, padding: 14, borderWidth: 1, borderColor: '#2196F3' },
  ...
  revLabel: { color: '#888', fontSize: 10 },
  ...
  emptySub: { color: '#888', fontSize: 14, textAlign: 'center', marginTop: 8, maxWidth: 280 },
  ...
  input: { backgroundColor: '#2a2a2a', borderRadius: 12, padding: 16, color: '#fff', fontSize: 16, borderWidth: 1, borderColor: '#444' },
  segGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  segChip: { paddingHorizontal: 14, paddingVertical: 8, borderRadius: 20, backgroundColor: '#2a2a2a', borderWidth: 1, borderColor: '#444' },
  ...
  mergeOption: { backgroundColor: '#2a2a2a', borderRadius: 10, padding: 14, marginBottom: 8, borderWidth: 1, borderColor: '#444' },
  mergeSelected: { borderColor: '#2196F3', backgroundColor: '#1e1e1e' },
  ...
  franchiseCountBadge: { position: 'absolute', top: -6, right: -6, backgroundColor: '#9C27B0', borderRadius: 10, minWidth: 20, height: 20, justifyContent: 'center', alignItems: 'center', paddingHorizontal: 4, borderWidth: 2, borderColor: '#333' },
  ...
  offerCompanyName: { color: '#aaa', fontSize: 13, fontWeight: '600' },
  ...
  offerPriceLabel: { color: '#888', fontSize: 11, marginBottom: 4 },
